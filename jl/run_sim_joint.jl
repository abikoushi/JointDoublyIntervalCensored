...
function simfunc(iter, sigma, tau, WE, WS, tdist)
    ...
    for j in 1:iter
        ...
        pv_inc_prob_j = jointtool.simulated_pvalue1(res.ccdf[2001:end,:], res.value, qs, tvalue)
        pv_intensity_j = jointtool.simulated_pvalue1(res.intensity[2001:end,:], res.value, qs_intensity, tvalue_intensity)
